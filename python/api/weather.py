...
from python.main.config import OPEN_WEATHER_MAP_API_KEY
...
from python.main.keyboards import create_weather_start_keyboard, create_weather_searchresult_keyboard, \
