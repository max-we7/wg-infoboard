...
try:
    ...
    try:
        ...
        schedule.every().day.at("16:02").do(update_muell)
        schedule.every().day.at("18:02").do(update_muell)
        schedule.every().day.at("20:02").do(update_muell)
        schedule.every().day.at("22:02").do(update_muell)
